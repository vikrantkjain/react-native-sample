...
export const isValidNumber = (value = '') => {
  return AppConstants.NUMBER_REGEX.test(value);
};
...
export const isNumber = (value = '') => {
  ...
  return Number.isInteger(parseInt(res));
};
...
export const isValidName = (value = '') => {
  return AppConstants.NAME_REGEX.test(value);
};

export const isValidFullName = (value = '') => {
  return AppConstants.FULLNAME_REGEX.test(value);
};

export const isSubjectLength = (value = '') => {
  const TextLength = value.length.toString();
  return +TextLength <= AppConstants.SUBJECT_MAX_LENGTH;
};
export const isMessageLength = (value = '') => {
  const TextLength = value.length.toString();
  return +TextLength <= AppConstants.MESSAGE_MAX_LENGTH;
};

export const isValidPinCode = (value = '') => {
  return AppConstants.PIN_CODE_REGEX.test(value);
};

export const isValidAddress = (value = '') => {
  return AppConstants.ADDRESS_REGEX.test(value);
};
...
export const isAddress = (value = '') => {
  ...
  let user = value;
  if (value === '') {
    isValid = Validation.validAdd;
  } else if (!isValidAddress(value)) {
    isValid = Validation.validAddFormat;
  }
  return [isValid, user];
};
...
export const isPincode = (value = '') => {
  let isValid = '';
  if (value === '') {
    isValid = Validation.validPincode;
  } else if (!isValidPinCode(value)) {
    isValid = Validation.validPincodeFormat;
  }
  return isValid;
};
...
export const isUserName = (value = '') => {
  let isValid = '';
  if (value === '') {
    isValid = Validation.validFirstName;
  } else if (!isValidName(value)) {
    isValid = Validation.validFirstNameFormat;
  }
  return isValid;
};

export const isUserLastName = (value = '') => {
  let isValid = '';
  if (value === '') {
    isValid = Validation.validLastName;
  } else if (!isValidName(value)) {
    isValid = Validation.validLastNameFormat;
  }
  return isValid;
};

export const isUserFullName = (value = '') => {
  let isValid = '';
  if (value === '') {
    isValid = Validation.FirstNameError;
...
export const isValidState = (value = '') => {
  let isValid = '';
  if (value === '') {
    isValid = Validation.validState;
  } else if (!isValidName(value)) {
    isValid = Validation.validStateFormat;
  }
  return isValid;
};

export const isValidLocality = (value = '') => {
  let isValid = '';
  if (value === '') {
    isValid = Validation.validCity;
  } else if (!isValidName(value)) {
    isValid = Validation.validLocalityFormat;
  }
  return isValid;
};
...
export const isValidCity = (value = '') => {
  ...
  if (value === '') {
    ...
    isValid = Validation.validCityFormat;
  }
  return isValid;
};
...
export const isUserNumber = (value = '') => {
  let isValid = '';
  if (value === '') {
    isValid = Validation.MobileNumberError;
  } else if (isNumber(value) && !isValidMobile(value)) {
    isValid = Validation.validMobileNumber;
  }
  return isValid;
};
...
export const isUserEmailNumber = (value = '') => {
  ...
  if (value === '') {
    ...
    isValid = Validation.validMobileFormat;
  } else if (!isNumber(value) && !isValidEmail(value)) {
    isValid = Validation.validEmailFormat;
  }
  return isValid;
};
...
export const isOTPPassword = (value = '') => {
  if (value.replace(/\s/g, '') === '') {
